...
<div class="container">
    <br>
    <header><h1>Registro Categoria</h1></header>
    <nav></nav>
    <section>
        <br>
        <main class="">
            <form  action="registerCategory" method="post">
                <div class="form-floating">
                    <input type="text" id="floatingInput" name="category_name"  class="form-control" placeholder="ingrese un nombre de categoria" required autofocus pattern="[A-Za-z ]{2,40}">
